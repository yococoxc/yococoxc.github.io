...
if(q)
{
a.report=("//badjs2.qq.com/badjs")+"?id="+q+"&uin="+parseInt(a.uin||(document.cookie.match(/\buin=\D+(\d+)/)||[])[1],10)+"&from="+encodeURIComponent(location.href)+"&ext="+JSON.stringify(a.ext)+"&";
}
return o;
...
var e=getTop();
var f=$.inWin();
e.loadJsFileToTop(['$js_path$webp/com/kits/qmfileupload/qqmail/js/ftn3934e0.js']);
function b(j,i,h)
{
...
var d={"t2AvatarDefault":{"1":e.getRes("$images_path$webp/resume/template/ico_t2AvatarDefault269d17.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t2AvatarDefault_2x269d17.png")},"t1AvatarDefault":{"1":e.getRes("$images_path$webp/resume/template/ico_t1AvatarDefault266ee1.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t1AvatarDefault_2x269d17.png")},"t1Account":{"1":e.getRes("$images_path$webp/resume/template/ico_t1Account_png8204dc9.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t1Account_2x269d17.png")},"t1Edu":{"1":e.getRes("$images_path$webp/resume/template/ico_t1Edu_png8204dc9.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t1Edu_2x269d17.png")},"t1Work":{"1":e.getRes("$images_path$webp/resume/template/ico_t1Work_png8204dc9.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t1Work_2x269d17.png")},"t1Tel":{"1":e.getRes("$images_path$webp/resume/template/ico_t1Tel_png8204dc9.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t1Tel_2x269d17.png")},"t1Email":{"1":e.getRes("$images_path$webp/resume/template/ico_t1Email_png8204dc9.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t1Email_2x269d17.png")},"t1Assess":{"1":e.getRes("$images_path$webp/resume/template/ico_t1Assess_png8204dc9.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t1Assess_2x269d17.png")},"t3AvatarDefault":{"1":e.getRes("$images_path$webp/resume/template/ico_t3AvatarDefault266ee1.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3AvatarDefault_2x269d17.png")},"timeline_top":{"1":e.getRes("$images_path$webp/resume/template/timeline_top20704c.png"),"2":e.getRes("$images_path$webp/resume/template/timeline_top_2x26ba16.png")},"timeline_bottom":{"1":e.getRes("$images_path$webp/resume/template/timeline_bottom20704c.png"),"2":e.getRes("$images_path$webp/resume/template/timeline_bottom_2x26ba16.png")},"timeline_mid":{"1":e.getRes("$images_path$webp/resume/template/timeline_mid26bfcd.png"),"2":e.getRes("$images_path$webp/resume/template/timeline_mid_2x26bfcd.png")},"t3EduExp":{"1":e.getRes("$images_path$webp/resume/template/ico_t3EduExp_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3EduExp_2x269d17.png")},"t3WorkExp":{"1":e.getRes("$images_path$webp/resume/template/ico_t3WorkExp_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3WorkExp_2x269d17.png")},"t3ProjectExp":{"1":e.getRes("$images_path$webp/resume/template/ico_t3ProjectExp_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3ProjectExp_2x269d17.png")},"t3SchoolExp":{"1":e.getRes("$images_path$webp/resume/template/ico_t3SchoolExp_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3SchoolExp_2x269d17.png")},"t3Awards":{"1":e.getRes("$images_path$webp/resume/template/ico_t3Awards_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3Awards_2x269d17.png")},"t3SelfEvaluation":{"1":e.getRes("$images_path$webp/resume/template/ico_t3SelfEvaluation_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3SelfEvaluation_2x269d17.png")},"t3CareerObjective":{"1":e.getRes("$images_path$webp/resume/template/ico_t3CareerObjective_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3CareerObjective_2x269d17.png")},"t3ProfessionalSkills":{"1":e.getRes("$images_path$webp/resume/template/ico_t3ProfessionalSkills_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3ProfessionalSkills_2x269d17.png")},"t3Custom":{"1":e.getRes("$images_path$webp/resume/template/ico_t3Custom_png8264f47.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t3Custom_2x269d17.png")},"t4AvatarDefault":{"1":e.getRes("$images_path$webp/resume/template/ico_t4AvatarDefault273b64.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t4AvatarDefault_2x273b64.png")},"t1EnAvatarDefault":{"1":e.getRes("$images_path$webp/resume/template/ico_t1EnAvatarDefault273b64.png"),"2":e.getRes("$images_path$webp/resume/template/ico_t1EnAvatarDefault_2x273b64.png")}};
...
e.loadJsFile('$js_path$webp/qmaddrface24e6b9.js',true,e.document,function(){
i(e.QMFaceEdit);
});
...
var g=[{id:'2',name:'\u6807\u51C6',imgVer:'20150617',thumb:a.getRes('$images_path$webp/resume/template226ba16.png'),midThumb:a.getRes('$images_path$webp/resume/template2_mid26ba16.png'),largeThumb:a.getRes('$images_path$webp/resume/template2_large_png827580b.png'),faceDefault:a.getRes('$images_path$webp/resume/template/ico_t2AvatarDefault269d17.png'),faceDefault_png8:'',faceInstead:''},{id:'4',name:'\u8868\u683C',imgVer:'20150617',thumb:a.getRes('$images_path$webp/resume/template326ba16.png'),midThumb:a.getRes('$images_path$webp/resume/template3_mid26ba16.png'),largeThumb:a.getRes('$images_path$webp/resume/template3_large_png827580b.png'),faceDefault:a.getRes('$images_path$webp/resume/template/ico_t3AvatarDefault266ee1.png'),faceDefault_png8:'',faceInstead:''},{id:'1',name:'\u5206\u680F',imgVer:'20150617',thumb:a.getRes('$images_path$webp/resume/template126ba16.png'),midThumb:a.getRes('$images_path$webp/resume/template1_mid26ba16.png'),largeThumb:a.getRes('$images_path$webp/resume/template1_large_png827580b.png'),faceDefault:a.getRes('$images_path$webp/resume/template/ico_t1AvatarDefault266ee1.png'),faceDefault_png8:'',faceInstead:''},{id:'3',name:'\u65F6\u95F4\u8F74',imgVer:'20150617',thumb:a.getRes('$images_path$webp/resume/template326ba16.png'),midThumb:a.getRes('$images_path$webp/resume/template3_mid26ba16.png'),largeThumb:a.getRes('$images_path$webp/resume/template3_large_png827580b.png'),faceDefault:a.getRes('$images_path$webp/resume/template/ico_t3AvatarDefault266ee1.png'),faceDefault_png8:'',faceInstead:''}];
var e=[{id:'en_1',name:'\u82F1\u6587\u7248',imgVer:'20150617',thumb:a.getRes('$images_path$webp/resume/template326ba16.png'),midThumb:a.getRes('$images_path$webp/resume/template3_mid26ba16.png'),largeThumb:a.getRes('$images_path$webp/resume/template3_large_png827580b.png'),faceDefault:a.getRes('$images_path$webp/resume/template/ico_t3AvatarDefault266ee1.png'),faceDefault_png8:'',faceInstead:''}];
...
d.empty_Info=c(l);
var n=['$@$if($visible$)$@$','<div style="%tmpl_gap%%tmpl_left_top%"><br /></div>','<div style="%tmpl_infoImgWrap%" ck="edit">','$@$if($avatar$)$@$','<img src="$avatar$" alt="\u7B80\u5386\u5934\u50CF" name="avatar.jpg" width="120" height="168" style="%tmpl_infoImg%" />','$@$else$@$','<img src="$images_path$webp/resume/template/ico_t1AvatarDefault266ee1.png" name="ico_t1AvatarDefault.png" output="false" alt="\u7B80\u5386\u5934\u50CF" width="120" height="168" style="%tmpl_infoImgDefault% content: url($@$eval getTop().getResumeIconUrl("t1AvatarDefault") $@$); _content: url($images_path$webp/resume/template/ico_t1AvatarDefault266ee1.png);" />','$@$endif$@$','<a class="resume_modifyAvatarWrap" output="false" hidefocus="" href="javascript:;">','<div class="resume_modifyAvatar">','<span class="resume_modifyAvatar_bg"></span>','<span class="resume_modifyAvatar_txt">\u4FEE\u6539\u5934\u50CF<span class="tmpl_mod_hiddenClick" ck="hideModule" mor="showFaceHideModeBtnUnderline" mot="hideFaceHideModeBtnUnderline">\u9690\u85CF</span></span>','</div>','</a>','</div>','<div class="tmpl_infoImgBase_gap" style="%tmpl_gap%%tmpl_infoImgBase_gap%">&nbsp;</div>','$@$else$@$','<div style="%tmpl_gap%%tmpl_left_smallTop%"><br /></div>','$@$endif$@$'];
d.face=c(n);
b.face=a(n);
var i=['<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0" ck="edit">','<tbody>','<tr>','<td class="tmpl_infoBase $falseDataColor$" style="%tmpl_tdFfFsLh%%tmpl_infoBase%">','$@$if($isEmpty$)$@$','<div style="%tmpl_infoName%">\u59D3\u540D</div>','$@$else$@$','<div class="$falseDataColorDark$" style="%tmpl_infoName%">$name$</div>','$@$endif$@$','<div style="%tmpl_gap%%tmpl_infoName_gap%">&nbsp;</div>','<div style="%tmpl_leftList%">','$@$if($isEmpty$ || (!$isEmpty$ && ($age$ || $sex$ || $city$) ) )$@$','<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0">','<tbody>','<tr>','<td valign="top" style="%tmpl_onlyImg%%tmpl_leftListImgWrap%">','<img name="ico_t1Account$imgVer$.png" src="$images_path$webp/resume/template/ico_t1Account_png8204dc9.png" alt="\u5E74\u9F84\u6027\u522B" style="%tmpl_leftListImg% content: url($@$eval getTop().getResumeIconUrl("t1Account") $@$); _content: url($images_path$webp/resume/template/ico_t1Account_png8204dc9.png);">','</td>','<td style="%tmpl_tdFfFsLh%%tmpl_leftListText%">','$@$if($isEmpty$)$@$','<div class="tmpl_ctrlDefaultShow" style="%tmpl_modCnt_noneLine%%tmpl_modCnt_noneLine_First%">&nbsp;</div>','$@$else$@$','$@$if($sex$)$@$$sex$&nbsp;&nbsp;$@$endif$@$','$@$if($age$)$@$$age$\u5C81&nbsp;&nbsp;$@$endif$@$','$@$if($city$)$@$$city$$@$endif$@$','$@$endif$@$','</td>','</tr>','</tbody>','</table>','$@$endif$@$','$@$if($isEmpty$ || (!$isEmpty$ && $highest_education$) )$@$','<div style="%tmpl_gap%%tmpl_leftListItem_gap%">&nbsp;</div>','<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0">','<tbody>','<tr>','<td valign="top" style="%tmpl_onlyImg%%tmpl_leftListImgWrap%">','<img name="ico_t1Edu$imgVer$.png" src="$images_path$webp/resume/template/ico_t1Edu_png8204dc9.png" alt="\u6700\u9AD8\u5B66\u5386" style="%tmpl_leftListImg% content: url($@$eval getTop().getResumeIconUrl("t1Edu") $@$); _content: url($images_path$webp/resume/template/ico_t1Edu_png8204dc9.png);">','</td>','<td style="%tmpl_tdFfFsLh%%tmpl_leftListText%">','$@$if($isEmpty$)$@$','<div class="tmpl_ctrlDefaultShow" style="%tmpl_modCnt_noneLine%%tmpl_modCnt_noneLine_First%">&nbsp;</div>','$@$else$@$','$highest_education$$@$if($highest_education$ == "\u5927\u4E13" || $highest_education$ == "\u672C\u79D1" || $highest_education$ == "\u7855\u58EB" || $highest_education$ == "\u535A\u58EB")$@$$@$endif$@$','$@$endif$@$','</td>','</tr>','</tbody>','</table>','$@$endif$@$','$@$if($isEmpty$ || (!$isEmpty$ && $work_seniority$) )$@$','<div style="%tmpl_gap%%tmpl_leftListItem_gap%">&nbsp;</div>','<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0">','<tbody>','<tr>','<td valign="top" style="%tmpl_onlyImg%%tmpl_leftListImgWrap%">','<img name="ico_t1Work$imgVer$.png" src="$images_path$webp/resume/template/ico_t1Work_png8204dc9.png" alt="\u5DE5\u4F5C\u5E74\u9650" style="%tmpl_leftListImg%content: url($@$eval getTop().getResumeIconUrl("t1Work") $@$); _content: url($images_path$webp/resume/template/ico_t1Work_png8204dc9.png);">','</td>','<td style="%tmpl_tdFfFsLh%%tmpl_leftListText%">','$@$if($isEmpty$)$@$','<div class="tmpl_ctrlDefaultShow" style="%tmpl_modCnt_noneLine%%tmpl_modCnt_noneLine_First%">&nbsp;</div>','$@$else$@$','$work_seniority$$@$if($work_seniority$ && $work_seniority$ != "\u5E94\u5C4A\u6BD5\u4E1A\u751F")$@$\u5DE5\u4F5C\u7ECF\u9A8C$@$endif$@$','$@$endif$@$','</td>','</tr>','</tbody>','</table>','$@$endif$@$','$@$if($isEmpty$ || (!$isEmpty$ && $mobile$) )$@$','<div style="%tmpl_gap%%tmpl_leftListItem_gap%">&nbsp;</div>','<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0">','<tbody>','<tr>','<td valign="top" style="%tmpl_onlyImg%%tmpl_leftListImgWrap%">','<img name="ico_t1Tel$imgVer$.png" src="$images_path$webp/resume/template/ico_t1Tel_png8204dc9.png" alt="\u624B\u673A" style="%tmpl_leftListImg% content: url($@$eval getTop().getResumeIconUrl("t1Tel") $@$); _content: url($images_path$webp/resume/template/ico_t1Tel_png8204dc9.png);">','</td>','<td style="%tmpl_tdFfFsLh%%tmpl_leftListText%">','$@$if($isEmpty$)$@$','<div class="tmpl_ctrlDefaultShow" style="%tmpl_modCnt_noneLine%%tmpl_modCnt_noneLine_First%">&nbsp;</div>','$@$else$@$','$mobile$','$@$endif$@$','</td>','</tr>','</tbody>','</table>','$@$endif$@$','$@$if($isEmpty$ || (!$isEmpty$ && $email$) )$@$','<div style="%tmpl_gap%%tmpl_leftListItem_gap%">&nbsp;</div>','<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0">','<tbody>','<tr>','<td valign="top" style="%tmpl_onlyImg%%tmpl_leftListImgWrap%_padding-top: 3px;">','<img name="ico_t1Email$imgVer$.png" src="$images_path$webp/resume/template/ico_t1Email_png8204dc9.png" alt="\u90AE\u7BB1" style="%tmpl_leftListImg% content: url($@$eval getTop().getResumeIconUrl("t1Email") $@$); _content: url($images_path$webp/resume/template/ico_t1Email_png8204dc9.png);">','</td>','<td style="%tmpl_tdFfFsLh%%tmpl_leftListText%">','$@$if($isEmpty$)$@$','<div class="tmpl_ctrlDefaultShow" style="%tmpl_modCnt_noneLine%%tmpl_modCnt_noneLine_First%">&nbsp;</div>','$@$else$@$','$email$','$@$endif$@$','</td>','</tr>','</tbody>','</table>','$@$endif$@$','</div></td>','</tr>','</tbody>','</table>'];
d.baseinfo=c(i);
b.baseinfo=a(i);
var u=['<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0">','<tbody>','<tr>','<td style="%tmpl_leftGap%">','$@$if(!$isEmpty$)$@$','<div style="%tmpl_leftGap_line%">&nbsp;</div>','$@$endif$@$','</td>','</tr>','</tbody>','</table>','<div class="js_self_evaluate" style="display: $@$if($visible$)$@$$@$else$@$none$@$endif$@$">','<div ck="edit" class="js_hover">','<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0">','<tbody>','<tr>','<td style="%tmpl_tdFfFsLh%%tmpl_selfAssess%">','<table width="%tmpl_leftWidth%" align="center" border="0" cellspacing="0" cellpadding="0">','<tbody>','<tr>','<td valign="top" style="%tmpl_onlyImg%%tmpl_leftListImgWrap%"><img name="ico_t1Assess$imgVer$.png" src="$images_path$webp/resume/template/ico_t1Assess_png8204dc9.png" alt="\u81EA\u6211\u8BC4\u4EF7" style="%tmpl_leftListImg% content: url($@$eval getTop().getResumeIconUrl("t1Assess") $@$); _content: url($images_path$webp/resume/template/ico_t1Assess_png8204dc9.png); vertical-align: -3px;"></td>','<td style="%tmpl_tdFfFsLh%%tmpl_leftListText%%tmpl_emptyText%position: relative;">\u81EA\u6211\u8BC4\u4EF7<a href="javascript:;" hidefocus="true" class="tmpl_ctrlDefaultHide tmpl_mod_hiddenClick" style="right: 8px;" ck="hideModule" output="false">\u9690\u85CF</a></td>','</tr>','</tbody>','</table>','$@$if($isEmpty$)$@$','<div class="tmpl_ctrlDefaultShow" style="%tmpl_modCnt_noneLine%%tmpl_modCnt_noneLine_First%">&nbsp;</div>','<div class="tmpl_ctrlDefaultHide" style="%tmpl_modCnt_noneLine_First%">&nbsp;</div>','$@$else$@$','<div style="%tmpl_gap%%tmpl_leftListItem_gap%">&nbsp;</div>','<div class="tmpl_selfAssessText $falseDataColor$" style="%tmpl_selfAssessText% width: %tmpl_leftWidth%;">$content$</div>','$@$endif$@$','</td>','</tr>','</tbody>','</table>','</div>','</div>'];
d.self_evaluate=c(u);
b.self_evaluate=a(u);
...
var m=['$@$if($visible$)$@$','<div ck="edit">','$@$if($avatar$)$@$','<img src="$avatar$" name="avatar.jpg" alt="\u7B80\u5386\u5934\u50CF" width="100" height="140" style="%tmpl_infoImg%" />','$@$else$@$','<div output="false">','<img name="ico_t3AvatarDefault.png" src="$images_path$webp/resume/template/ico_t3AvatarDefault266ee1.png" alt="\u7B80\u5386\u5934\u50CF" width="100" height="140" style="%tmpl_infoImg_Default% content: url($@$eval getTop().getResumeIconUrl("t3AvatarDefault") $@$); _content: url($images_path$webp/resume/template/ico_t3AvatarDefault266ee1.png);" />','</div>','$@$endif$@$','<a class="resume_modifyAvatarWrap" output="false" hidefocus="" href="javascript:;">','<div class="resume_modifyAvatar">','<span class="resume_modifyAvatar_bg"></span>','<span class="resume_modifyAvatar_txt">\u4FEE\u6539\u5934\u50CF<span class="tmpl_mod_hiddenClick" ck="hideModule" output="false" mor="showFaceHideModeBtnUnderline" mot="hideFaceHideModeBtnUnderline">\u9690\u85CF</span></span>','</div>','</a>','</div>','$@$endif$@$'];
d.face=c(m);
b.face=a(m);
...
var i=$.lib('resume.viewmgr').getTpl('layout.loading').replace({loading_gif:a.getRes('$images_path$webp/ico_loading21e9c5d.gif')});
...
d.html(this.getView('layout.loading',{loading_gif:a.getRes('$images_path$webp/ico_loading21e9c5d.gif')}));
return this;
},rule:function(){
