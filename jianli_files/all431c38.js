...
loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor40bcf4.js"]);
loadingBox({model:"\u53D1\u4FE1",js:["$js_path$libcompose3e5857.js","$js_path$qmaddrinput24e6ae.js"],oncheck:function(){
...
if(d(n))
{
r="<span style='border-bottom:1px dashed #ccc;z-index:1' t='7' onclick='return false;' data='"+m+"'>"+m+"</span>";
...
var I=a.href;
I=trim2(I);
QMAjax.send(I,{method:"POST",content:"sid="+getSid(),onload:function(e,P){
if(e)
{
if(/<!--cgi exception-->/ig.test(P))
{
var U=(/<!--cgierrorcode:-([\d]+)-->/ig.test(P)&&RegExp.$1);
if("821"==U)
{
showError("\u5BF9\u65B9\u5DF2\u505C\u6B62\u5171\u4EAB\u65E5\u5386");
}
...
{
var R=(/<!--email:([\W\w]+?)-->/ig.test(P)&&RegExp.$1);
showError("\u8BF7\u767B\u5F55\u8D26\u53F7"+R+"\u91CD\u65B0\u52A0\u5165\u65E5\u5386");
}
else if("823"==U)
{
showError("\u9080\u8BF7\u90AE\u4EF6\u5DF2\u8FC7\u671F");
...
{
var Q=getTop();
Q.goUrl(Q,[Q.location.protocol,"//",Q.location.hostname,"/cgi-bin/loginpage"].join(""));
}
else{
showError("\u52A0\u5165\u5931\u8D25");
}
...
{
showInfo("\u53D1\u9001\u9A8C\u8BC1\u7801...");
QMAjax.send("/cgi-bin/gen_safecode",{method:"POST",content:["t=apple_id_verify.json&mailid=",encodeURIComponent(y),"&type=",encodeURIComponent(G)].join(""),onload:function(e,P){
var Q=evalValue(P||"{}");
if(e&&Q&&Q.resCode=="0")
{
showInfo("\u9A8C\u8BC1\u7801\u5DF2\u53D1\u9001");
...
function J()
{
var P=g.S("ipt_username"),e=P.value||"";
if(e.length<6)
{
showError("\u8BF7\u8F93\u51656\u4F4D\u9A8C\u8BC1\u7801");
return;
}
QMAjax.send("/cgi-bin/gen_safecode",{method:"POST",content:["type=appleid_check&t=apple_id_verify.json&mailid=",encodeURIComponent(y),"&safecode=",encodeURIComponent(e)].join(""),onload:function(Q,R){
var U=evalValue(R||"{}");
if(Q&&U&&U.resCode=="0")
{
showInfo("\u9A8C\u8BC1\u901A\u8FC7\uFF0C\u8BFB\u4FE1\u4E2D...");
...
var P=this,e=P.S("ipt_username");
e.focus();
P.S("geConfirmBtn").onclick=function(){
J();
};
P.S("geCancelBtn").onclick=function(){
P.close();
};
e.onkeydown=function(Q){
...
e.oninput=e.onpropertychange=function(Q){
...
QMAjax.send(I,{method:"POST",content:"fun=followshare&followuin="+v+"&sid="+getSid(),onload:function(e,P){
if(e)
{
...
D||(D=c);
var O=window.open(T('$baseDomain$/cgi-bin/mail_spam?action=check_link&url=$url$&mailid=$mid$&spam=$spam$').replace({baseDomain:getTop().getTopHost(),mid:D,spam:b=="spam"?1:0,url:encodeURI(a.href)}),"_blank");
O&&(O.opener=null);
return false;
}
...
{
cacheByIframe(a&&a.defcss==false?[]:[["css","",getRes("$css_path$comm3b56cc.css")],["css",getPath("style"),"skin"]],extend({className:"menu_base_if",transparent:false,destroy:false},a,{win:b,header:["<script>",getTop.toString().replace(/[\r\n]/g,""),"<\/script>",a&&a.header||""].join(""),onload:function(c){
...
c.loadCssFile("$css_path$login/addAccount327bfb.css",true,c.document);
a._oDialog=new c.QMDialog({sId:"id_VerifyAccount",sTitle:"\u8EAB\u4EFD\u9A8C\u8BC1",nWidth:440,sBodyHtml:a._oTmpl.replace({"username":d,"ptloginurl":a.getPtloginUrl({"uin":c.getUin()})}),bAnimation:false,onshow:function(){
var f=this;
getTop().ptlogin2_onResize=a.ptlogin2OnResize(f);
getTop().ptloginResize();
f.S("geCancelBtn").onclick=function(){
f.close();
};
},onclose:function(){
if(this.reloadLeftWin)
...
if(!a._oDefaultCfg)
{
a._oDefaultCfg={"topHost":_oTop.getTopHost(),"sid":_oTop.getSid(),"topProtocol":_oTop.location.protocol,"ver":a.getCssVer(),"loginDesc":encodeURIComponent('\u9A8C\u8BC1'),"cbName":"toVerifyQQAccount","cssFilename":"addAccountPtlogin"};
}
return a._oDefaultCfg;
},ptlogin2OnResize:function(a){
return function(j,h){
...
var a={'comm2010.css':'$css_path$comm20103fb4e1.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
